...
<body>
	...
	<ul >
			...
			<div id="main">
				<!--div id="main2"></div-->
				<h2> Ms Thanani S</h2>
				    <img id="image2" src="img/pkn.JPEG" align="left" style= "width:20%; height:20%">
			

			    <p> I am doing B.E in ISE from Jyothy Institute of Technology, Bangalore.
 I am currently learning web development from a online platform. I have also worked on different
...
objective.    <br><right><h3 style="margin-top:-30px;">Follow Me Through</h3></center>
			  </p>
